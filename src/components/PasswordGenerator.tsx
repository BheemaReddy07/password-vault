...
const PasswordGenerator: React.FC<PasswordGeneratorProps> = ({
  length = 12,
  options = { lower: true, upper: true, numbers: true, symbols: false, excludeLookAlikes: false },
  setLength,
  setOptions,
  handleGenerate,
  loading,
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <label className="flex items-center space-x-2 col-span-2">
          <input
            ...
            onChange={() => setOptions({ ...options, excludeLookAlikes: !options.excludeLookAlikes })}
            className="h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300 rounded"
            disabled={loading}
          />
          <span className="text-sm text-gray-600">Exclude Look-Alike Characters (i, l, 1, L, o, 0, O)</span>
        </label>
      </div>
